...
<script type="text/javascript">
			function addProduct(){
				window.location.href = "${pageContext.request.contextPath}/product?method=adminAddProductUI";
			}
			...
			function delProduct(pid){
				...
				if(isDel){
					//要删除
					location.href = "${pageContext.request.contextPath}/product?method=adminDelProduct&pid="+pid;
				}
			}
...
<body>
	<br>
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/product?method=adminSearchProductList" method="post">
							...
							<c:forEach items="${productList }" var="pro" varStatus="vs">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/product?method=adminUpdateProductUI&pid=${pro.pid}">
											<img
